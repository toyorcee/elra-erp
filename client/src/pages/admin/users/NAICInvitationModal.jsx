...
const NAICInvitationModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const positionDepartmentMapping = {
    ...
    "General Staff": "CLAIMS", // Default to Claims
    "Junior Staff": "CLAIMS", // Default to Claims
  };
...
export default NAICInvitationModal;
