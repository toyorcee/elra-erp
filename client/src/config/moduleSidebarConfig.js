    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: "Add existing or new employees to system",
          },
          {
          ...
          },
          {
            ...
            icon: "BookOpenIcon",
            path: "/dashboard/modules/hr/onboarding-guide",
            required: { minLevel: 300 },
            description: "Employee onboarding process documentation",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            required: { minLevel: 600 },
            description: "Evaluate employee skills and competencies",
          },
          {
            ...
            required: { minLevel: 600 },
            description: "Manage training initiatives and programs",
          },
          {
            label: "Career Development",
            icon: "ArrowTrendingUpIcon",
            path: "/dashboard/modules/hr/performance/career",
            required: { minLevel: 600 },
            description: "Track career progression and goals",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            path: "/dashboard/modules/hr/salary-grades",
            required: { minLevel: 700 },
