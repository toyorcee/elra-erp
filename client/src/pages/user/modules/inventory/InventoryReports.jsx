...
const InventoryReports = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">You don't have permission to access Inventory Reports.</p>
        </div>
      </div>
    );
  }
  ...
  const loadReports = async () => {
    ...
    try {
      // Mock data for now
      setReports([
        { id: 1, name: "Inventory Status Report", type: "status", date: "2024-01-15" },
        { id: 2, name: "Maintenance Schedule Report", type: "maintenance", date: "2024-01-10" },
        { id: 3, name: "Lease Utilization Report", type: "utilization", date: "2024-01-05" },
      ]);
    } catch (error) {
