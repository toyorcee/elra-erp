    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-cyan-50">
      ...
      <div className="relative overflow-hidden border-b border-gray-100">
        ...
        <div className="relative z-10 px-4 sm:px-6 py-12 sm:py-14">
          ...
          >
            <div className="inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 rounded-3xl bg-gradient-to-br from-emerald-500 to-teal-600 shadow-xl mb-6">
              <FaMoneyBillWave className="h-7 w-7 sm:h-8 sm:w-8 text-white" />
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-emerald-600 via-teal-600 to-indigo-600 bg-clip-text text-transparent mb-4 sm:mb-6">
              Payroll Management
            </h1>
      ...
      <div className="px-4 sm:px-6 pb-16">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Access comprehensive payroll management and processing tools
          </p>
        </motion.div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-6 sm:p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Jump to the most-used payroll management tools
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
              {quickActions.map((action, index) => {
                ...
                return (
                  ...
                  >
                    <button
                      className="group flex items-center p-4 sm:p-6 rounded-2xl border border-gray-200 hover:border-emerald-300 hover:bg-emerald-50 transition-all duration-300 transform hover:scale-105 w-full"
                    ...
                    >
                      ...
                      <span className="text-gray-800 font-semibold group-hover:text-emerald-700 transition-colors text-sm sm:text-base">
                        {action.title}
                      </span>
                    </button>
                  </motion.div>
