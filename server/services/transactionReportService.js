...
class TransactionReportService {
  ...
  generateReportContent(
    ...
    const elraLogo = loadReportImage("elra-logo.jpg");
    if (elraLogo) {
      try {
        ...
        console.warn(
          "⚠️ Could not add ELRA logo to transaction report, falling back to text:",
          error.message
        );
        doc.setTextColor(elraGreen[0], elraGreen[1], elraGreen[2]);
        doc.setFontSize(24);
    ...
    doc.setFontSize(16);
    doc.setFont("helvetica", "bold");
    doc.text("Wallet Transaction Report", pageWidth / 2, 70, {
      align: "center",
    });
    ...
    if (transactions.length > 0) {
      ...
      autoTable(doc, {
        ...
        didDrawPage: function (data) {
          ...
          doc.text(
            `Page ${currentPage} of ${pageCount} - Generated by ELRA ERP System`,
            pageWidth / 2,
            pageHeight - 5,
            { align: "center" }
          );
    ...
    // Footer is now handled in the didDrawPage callback
  }
