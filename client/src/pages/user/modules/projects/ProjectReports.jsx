...
const ProjectReports = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">You don't have permission to access Project Reports.</p>
        </div>
      </div>
    );
  }
  ...
  const loadReports = async () => {
    ...
    try {
      // Mock data for now
      setReports([
        { id: 1, name: "Monthly Project Summary", type: "summary", date: "2024-01-15" },
        { id: 2, name: "Budget Analysis Report", type: "budget", date: "2024-01-10" },
        { id: 3, name: "Team Performance Report", type: "performance", date: "2024-01-05" },
      ]);
    } catch (error) {
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="text-gray-600">Generate comprehensive project reports for ELRA</p>
          </div>
